...
def load_and_extract_data(uploaded_file):
    ...
    try:
        ...
        return {"status": "success", "df": df, "message": f"Arquivo '{uploaded_file.name}' carregado com sucesso. DataFrame pronto para análise. (OBS: Amostra de 10% usada para teste de gráfico no Streamlit Cloud)"}
